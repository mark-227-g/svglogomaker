...
class Triangle extends Shape {
    ...
    render() {
        ...
        **************************************/
        ...
        return(`<polygon points="${this.x} ${this.y+this.height},${this.x+(this.width/2)} ${this.x}, ${this.x+this.width} ${this.y+this.height}" fill="${this.color.toLowerCase().toLowerCase()}" />`);    
    };
};
